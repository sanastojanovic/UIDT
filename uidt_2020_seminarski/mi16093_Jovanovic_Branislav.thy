...
(*    Leme koje dokazuju medjukorak izmedju 
      a^3 - a^2*b - a^2 - a^2*b + a*b^2 + a*b - a*b + b^2 + b i (a^2 - a*b - b) * (a -b -1)     *)
...
proof-
  ...
  also have "... =  a^3  - (a^2)*b  - a^2 + a*(b^2) - (a^2)*b + a*b + b^2 + b - a*b" by auto
...
proof-
  ...
  also have "... = (a^2 - a*b -b) * (a -b -1)"
    using assms(1) medjukorak_2_spajanje by blast
...
(*  Ili kraće zapisano samo   *)
lemma S_1:
  fixes a b :: nat 
  assumes "a>b"
  shows "a^2 - a*b - b ≥ 0" by simp
