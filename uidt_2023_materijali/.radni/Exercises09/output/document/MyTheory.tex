...
\end{isamarkuptext}\isamarkuptrue%
\isacommand{fun}\isamarkupfalse%
\ stepenuj\ {\isacharparenleft}{\kern0pt}\isakeyword{infixl}\ {\isachardoublequoteopen}{\isasymZcat}{\isachardoublequoteclose}\ {\isadigit{1}}{\isadigit{0}}{\isadigit{2}}{\isacharparenright}{\kern0pt}\ \isakeyword{where}\isanewline
...
\ \ \isakeyword{shows}\ {\isachardoublequoteopen}a\ {\isasymZcat}\ {\isacharparenleft}{\kern0pt}n\ {\isasymotimes}\ m{\isacharparenright}{\kern0pt}\ {\isacharequal}{\kern0pt}\ a\ {\isasymZcat}\ n\ {\isasymZcat}\ m{\isachardoublequoteclose}\isanewline
\ \ %
\isadelimproof
%
\endisadelimproof
