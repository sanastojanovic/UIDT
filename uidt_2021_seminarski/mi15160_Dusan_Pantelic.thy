...
(b) Dokazati da postoji beskonacno pozitivnih celih brojeva n tako da ne postoji razlomak a/b
gde su a i b celi brojevi za koje vazi 0 < b \<le>  n^(1/2) + 1 i
n^(1/2) \<le> a/b \<le> (n+1)^(1/2)
\<close>
...
lemma A5_a:
  ...
  shows "\<forall> n. \<exists>a b. 0<b \<and> b\<le>sqrt n \<and> sqrt n \<le> a/b \<and> a/b \<ge> sqrt (n+1)"
  using assms
proof (cases "s mod 2 = 0")
  ...
  then have "b \<ge> 0 \<and> b \<le> srt n" using assms by force
